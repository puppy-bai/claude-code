...
- **🎨 18 种物种补全**: 告别原本简单的占位符，现在支持 18 种精美的 ASCII 艺术宠物形态！完整列表包括：
  ...
  ```text
  duck (鸭子)      goose (鹅)       blob (史莱姆)    cat (猫咪)       dragon (小龙)    octopus (章鱼)
      __               (·>             .----.          /\_/\            /^\  /^\          .----.   
    <({E} )___         ||             ( {E}  {E} )        ( {E}   {E})        <  {E}  {E}  >        ( {E}  {E} )  
     (  ._>          _(__)_           (      )         (  ω  )          (   ~~   )        (______)  
      `--´            ^^^^             `----´          (")_(")           `-vvvv-´         /\/\/\/\  

  owl (猫头鹰)     penguin (企鹅)   turtle (乌龟)    snail (蜗牛)     ghost (幽灵)     axolotl (美西螈)
     /\  /\          .---.            _,--._         {E}    .--.         .----.         }~(______)~{
    (({E})({E}))        ({E}>{E})          ( {E}  {E} )         \  ( @ )        / {E}  {E} \        }~({E} .. {E})~{
    (  ><  )        /(   )\         /[______]\         \_`--´         |      |          ( .--. )  
     `----´          `---´            ``    ``        ~~~~~~~         ~`~``~`~          (_/  \_)  

  capybara(水豚)   cactus(仙人掌)   robot (机器人)   rabbit (兔子)    mushroom(蘑菇)   chonk (胖橘)
    n______n       n  ____  n         .[||].          (\__/)          .-o-OO-o-.        /\    /\  
   ( {E}    {E} )      | |{E}  {E}| |        [ {E}  {E} ]        ( {E}  {E} )        (__________)      ( {E}    {E} ) 
   (   oo   )      |_|    |_|        [ ==== ]        =(  ..  )=          |{E}  {E}|         (   ..   ) 
    `------´         |    |          `------´         (")__(")           |____|          `------´  
  ```
- **🎩 自由换装系统**:
